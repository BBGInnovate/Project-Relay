...
/**
 *  @file
 *  Create the 'SoundCloud' tab for the WYSIWYG plugins.
 */

// (function ($) {
//   namespace('Drupal.media.browser.plugin');
//
//   Drupal.media.browser.plugin.media_soundcloud = function(mediaBrowser, options) {
//     return {
//       init: function() {
//         tabset = mediaBrowser.getTabset();
//         tabset.tabs('add', '#media_soundcloud', 'SoundCloud');
//         mediaBrowser.listen('tabs.show', function (e, id) {
//           if (id == 'media_soundcloud') {
//             // We only need to set this once.
//             // We probably could set it upon load.
//             if (mediaBrowser.getActivePanel().html() == '') {
//               mediaBrowser.getActivePanel().html(options.media_soundcloud);
//             }
//           }
//         });
//       }
...
//   //@todo: needs a review.
//   Drupal.media.browser.register('media_soundcloud', Drupal.media.browser.plugin.media_soundcloud, {});
// })(jQuery);

(function ($) {
  namespace('media.browser.plugin');

  Drupal.media.browser.plugin.soundcloud_library = function(mediaBrowser, options) {

    return {
      mediaFiles: [],
      init: function() {
        tabset = mediaBrowser.getTabset();
        tabset.tabs('add', '#soundcloud_library', 'SoundCloud');
        var that = this;
        mediaBrowser.listen('tabs.show', function (e, id) {
          if (id == 'soundcloud_library') {
  ...
  Drupal.media.browser.register('soundcloud_library', Drupal.media.browser.plugin.soundcloud_library);
})(jQuery);
